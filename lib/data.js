...
const DEFAULT_CONFIG = {
  ...
  ciudades_cobertura: "",
  tiempo_entrega: "",
  metodos_pago: { contraentrega: true, tarjeta: true, pse: true, transferencia: true, addi: true },
  recargos: {
...
export async function getApprovedReviews(marca) {
  try {
    const supabase = createPublicClient();
